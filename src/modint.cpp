...
class ModInt {
    int64_t n;
public:
    inline ModInt(const ModInt &o) noexcept : n(o.n) {}
    inline ModInt(int64_t n = 0) noexcept : n((n >= MOD) ? (n % MOD) : (n < 0) ? ((n + MOD) % MOD) : n) {}
    ...
    inline ModInt& operator*=(ModInt o) noexcept { n = (n * o.n) % MOD; return *this; }
    inline ModInt& operator/=(ModInt o) noexcept { n = (n * o.inv().n) % MOD; return *this; }
    inline ModInt operator+(ModInt o) noexcept { return ModInt(*this) += o; }
    inline ModInt operator-(ModInt o) noexcept { return ModInt(*this) -= o; }
    inline ModInt operator*(ModInt o) noexcept { return ModInt(*this) *= o; }
    inline ModInt operator/(ModInt o) noexcept { return ModInt(*this) /= o; }
    ...
    friend ostream& operator<<(ostream &os, ModInt o) noexcept { os << o.n; return os; }
    friend istream& operator>>(istream &is, ModInt &o) noexcept  { is >> o.n; return is; }
